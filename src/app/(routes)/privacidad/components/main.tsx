export default function Main() {
  return (
    <div className="layout-container my-16">
      <h1 className="text-center mt-28 mb-16 text-3xl font-bold">Politicas de privacidad</h1>
      <p className="text-base leading-relaxed">
        {" "}
        <span className="font-semibold">1. Información recopilada:</span> Recopilaremos la siguiente
        ...
        <br />
        <span className="font-semibold">2. Uso de la información:</span> La información recopilada se
        ...
        <br />
        <br /> <span className="font-semibold">3. Protección de la información:</span> Nos comprometemos a
        ...
        <br />
        <br /> <span className="font-semibold">4. Compartir información:</span> No compartiremos su
        información personal con terceros sin su consentimiento, a menos que sea
        necesario para cumplir con requisitos legales.
        <br />
        <br /> <span className="font-semibold">5. Duración del almacenamiento:</span> La información
        ...
        <br />
        <span className="font-semibold">6. Preferencias de cookies:</span> No utilizamos cookies ni otras
        tecnologías de seguimiento en nuestro formulario de solicitud de
        presupuesto.
        <br />
        <br /> <span className="font-semibold">7. Derechos del usuario:</span> Usted tiene el derecho de
        ...
        comuníquese con nosotros a través de lapservicees@gmail.com
        <br />
        <br /> <span className="font-semibold">8. Aceptación de los términos:</span> Al enviar el
